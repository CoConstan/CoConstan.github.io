...
Voici un exemple d'une visualisation qui serait longue et fastidieuse en `Matplotlib` qui est très simple à faire en utilisant `Seaborn` sur le dataset _Iris_ :
